                            ...
                            <div class="col-12  d-flex justify-content-center mb-3 ">
                                <article class="card lit shadow">
                                    <img src="{{ !$article->images()->get()->isEmpty()? $article->images()->first()->getUrl(400, 300): 'https://picsum.photos/200' }}"
                                        class="card-img-top img-tran" alt="Immagine Articolo">
                                    <div class="card-body">
                                        ...
                                        <p class="my-2 " href="#">Pubblicato il:
                                            {{ $article->created_at->format('d/m/Y') }}</p>
                                        <a class="me-3 text-dark my-5"
                                            href="{{ route('categoryShow', ['category' => $article->category]) }}">Categoria:
                ...
                <div class=" d-flex justify-content-between">
                    <div class="col-12 col-md-3  my-5 d-flex align-items-center flex-column w-25">
                        <a href="{{ route('categoryShow', '1') }} "><img src="/img/fotografia.jpg"
                                class="rounded-circle btn shadow d-flex align-items-center my-2"></a>
