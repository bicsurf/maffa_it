<x-layout>
  ...
  <div class="container-fluid my-5">
    <div class="row justyfi-content-center">
      <h1 class="text-center">Categorie</h1>
      @foreach ($categories as $category)
        <div class="col-12 col-md-3 botone my-5 d-flex align-items-center flex-column ">
          <img src="/img/telefonia.jpg" class="rounded-circle btn shadow d-flex align-items-center my-2" href="{{ route('categoryShow', compact('category')) }}" alt="...">
